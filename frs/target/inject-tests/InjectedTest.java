...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","/media/xp/HARISH/CODE/jenkins/compile for MY-plugin/frs");
    parameters.put("artifactId","frs");
    parameters.put("outputDirectory","/media/xp/HARISH/CODE/jenkins/compile for MY-plugin/frs/target/classes");
    parameters.put("testOutputDirectory","/media/xp/HARISH/CODE/jenkins/compile for MY-plugin/frs/target/test-classes");
