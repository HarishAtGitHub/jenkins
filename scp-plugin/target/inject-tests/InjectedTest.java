...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","/media/xp/HARISH/CODE/jenkins/jenkins plugin/scp/scp-plugin");
    parameters.put("artifactId","scp");
    parameters.put("outputDirectory","/media/xp/HARISH/CODE/jenkins/jenkins plugin/scp/scp-plugin/target/classes");
    parameters.put("testOutputDirectory","/media/xp/HARISH/CODE/jenkins/jenkins plugin/scp/scp-plugin/target/test-classes");
